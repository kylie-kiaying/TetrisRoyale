    ...
    <BackgroundWrapper>
      ...
      <div className="flex w-full flex-grow items-start justify-center pb-10 pt-14">
        <Card className="w-[1000px] max-w-screen-xl items-center rounded-lg border-0 shadow-lg backdrop-blur-md">
          ...
          <CardContent>
            <Card className="max-w-[1000px] items-center justify-center rounded-lg border-none shadow-lg backdrop-blur-md">
              {tournamentPlayable ? (
                loading ? (
                ...
                <div className="text-center">
                  <CardDescription>
                    Tournament cannot be started with current number of players
                    or current date.
                  </CardDescription>
                  <CardDescription>
                    Number of registrants: {registrants.length}
                  ...
                  <CardDescription>
                    Supposed Start Date:{' '}
                    {tournamentData ? tournamentData.tournament_start : 'N/A'}
                  </CardDescription>
                  <CardDescription>
